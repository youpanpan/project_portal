...
import com.chengxuunion.projectportal.common.interceptor.LoginInterceptor;
import com.chengxuunion.projectportal.common.interceptor.UrlAuthInterceptor;
import com.chengxuunion.projectportal.common.util.SessionUtils;
import com.chengxuunion.projectportal.common.util.SpringUtil;
...
public class WebConfig extends WebMvcConfigurationSupport {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(SpringUtil.getBean(LoginInterceptor.class)).addPathPatterns("/**")
