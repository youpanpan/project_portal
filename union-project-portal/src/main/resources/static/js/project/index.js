    ...
    layui.use(['form', 'table','layer'], function() {
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'projectUrl',  title: '项目地址'},
                {field: 'projectImage',  title: '项目图片', templet: '#projectImageTpl'},
                {field: 'bgColor',  title: '背景颜色', templet: '#bgColorTpl'},
                {field: 'official',  title: '是否官方', templet: '#officialTpl'},
        ...
        $("#j-search-btn").click(function(){
            ...
            table.reload('listDataTable01', {
                where: { projectName: projectName, official: official},
            });
